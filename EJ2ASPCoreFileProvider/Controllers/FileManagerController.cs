...
public class FileManagerController : Controller
{
	...
	public IActionResult Upload(string path, long size, IList<IFormFile> uploadFiles, string action, string rootFolder)
	{
		SetRoot(rootFolder);
		try
		{
	...
	[Route("GetImage")]
	public IActionResult GetImage(FileManagerDirectoryContent args, [FromQuery] string rootFolder)
	{
		SetRoot(rootFolder);
		return operation.GetImage(rootFolder, args.Id, false, null, null);
	}
}
