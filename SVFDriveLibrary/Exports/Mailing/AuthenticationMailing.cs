...
namespace SVFDriveLibrary.Exports.Mailing;
...
public static class AuthenticationMailing
{
    ...
    {
        var subject = "Your Login Code for SVF Drive";
    ...
    private static async Task SendEmailToUser(string toName, string toEmail, string subject, string htmlBody)
    {
        ...
        message.From.Add(new MailboxAddress("SVF Drive", Secrets.Email));
                    ...
                    <tr>
                        <td class=""content-padding"" style=""padding: 40px;"">
                            ...
                            <p style=""margin: 0 0 30px 0; color: #666666; font-size: 16px; line-height: 1.6;"">
                                You've requested a login code for your SVF Drive account. Use the code below to complete your sign-in:
                            </p>
                            ...
                            <table role=""presentation"" style=""width: 100%; border-collapse: collapse; margin: 20px 0;"">
                                <tr>
                                    <td align=""center"">
                                        <a href=""{redirectLink}"" style=""display: inline-block; padding: 14px 40px; background: linear-gradient(135deg, #3b82f6 0%, #1e40af 100%); color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 12px rgba(59, 130, 246, 0.3);"">Go to SVF Drive Login</a>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td class=""footer-padding"" style=""padding: 30px 40px; background-color: #f8fafc; border-radius: 0 0 12px 12px; border-top: 1px solid #e2e8f0;"">
                            <p style=""margin: 0 0 10px 0; color: #999999; font-size: 14px; line-height: 1.6;"">
                                Best regards,<br>
                                <strong style=""color: #1e40af;"">The SVF Team</strong>
                            </p>
                            <p style=""margin: 20px 0 0 0; color: #999999; font-size: 12px; line-height: 1.6;"">
                                This is an automated message, please do not reply to this email.<br>
                                <a href=""{Secrets.CompanyWebsite}"" style=""color: #2563eb; text-decoration: none;"">Visit our website</a>
                            </p>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td align=""center"" style=""padding: 0 40px;"">
                            <p style=""margin: 0; color: #999999; font-size: 12px; line-height: 1.6;"">
                                © {DateTime.Now.Year} SVF. All rights reserved.
                            </p>
                        </td>
                    </tr>
                </table>
